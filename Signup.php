...
<body>
    ...
    <div class="container-fluid p-0" style="margin-top: 70px;">
        <img class="object-fit-cover w-100 position-fixed top-0 z-n1 " style="height: 100vh;" src="assets/images/pattern-1708767434709-5127.jpg" alt="/">
        <div class="container-fluid d-sm-flex flex-row align-items-center justify-content-center" style="height: 100vh;">
            <div class="col-xxl-10 col-xl-10 col-lg-11 col-md-11 col-sm-11 main row bg-light shadow-lg border boredr-2 border-light  ">
